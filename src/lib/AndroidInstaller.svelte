...
<div id="menu-install-pwa-android" class="menu menu-box-bottom menu-box-detached rounded-l"
        ...
        <div class="boxed-text-l mt-4">
            ...
            <h4 class="mt-3">Add ScholarPaddi on your Home Screen</h4>
            <p>
                Install ScholarPaddi on your home screen, and access it just like a regular app. It really is that simple!
            </p>
