        ...
        <div class="footer card card-style">
            <a href="#" class="footer-title"><span class="color-highlight">ScholarPaddi</span></a>
            <p class="footer-text"><span>Made with <i class="fa fa-heart color-highlight font-16 pl-2 pr-2"></i> by Teknocrats</span><br><br>Powered by the best Mobile Website Developer on Envato Market. Elite Quality. Elite Products.</p>
            ...
            <p class="footer-copyright">Copyright &copy; Teknocrats <span id="copyright-year">2021</span>. All Rights Reserved.</p>
